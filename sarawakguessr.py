...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.result_label = ctk.CTkLabel(self.left_frame, text="", justify="left")
    ...
    def submit_guess(self):
        ...
        self.map_widget.set_marker(actual_lat, actual_lon, text="Correct Location")
